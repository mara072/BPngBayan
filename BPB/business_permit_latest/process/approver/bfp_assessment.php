...
if (isset($_POST['bfp_assessment'])) {
    $id = $_POST['bfp_assessment_id'];
    $assessment_file = ($_FILES['bfp_assessment']['tmp_name']);
    ...
    $query = "UPDATE bfp_db SET assessment = '$assessment' WHERE id = '$id'";
